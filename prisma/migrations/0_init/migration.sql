...
-- CreateIndex
CREATE UNIQUE INDEX "_AchievementToPlayer_AB_idx" ON "_AchievementToPlayer"("A", "B");

-- CreateIndex
CREATE INDEX "_AchievementToPlayer_B_index" ON "_AchievementToPlayer"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_AchievementToTeam_AB_idx" ON "_AchievementToTeam"("A", "B");

-- CreateIndex
CREATE INDEX "_AchievementToTeam_B_index" ON "_AchievementToTeam"("B");

-- CreateIndex
CREATE UNIQUE INDEX "_TeamToTournament_AB_idx" ON "_TeamToTournament"("A", "B");
